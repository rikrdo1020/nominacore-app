...
try {
    electron_1.contextBridge.exposeInMainWorld('api', {
        ...
        updateRateRule: (id, maxReg, regRate, otRate, lunchDuration) => apiPut(`/rate-rules/${id}`, {
        ...
        addWorkRecord: (record) => apiPost('/work-records', {
        ...
        updateWorkRecord: (id, record) => apiPut(`/work-records/${id}`, {
            entryTime: record.entry_time,
            exitTime: record.exit_time,
            directHours: record.direct_hours,
            isDirectEntry: record.is_direct_entry,
        ...
        addDeduction: (ded) => apiPost('/deductions', {
        ...
        savePayroll: (empId, start, end, paidAt) => apiPost('/payroll/save', {
            employeeId: empId,
            periodStart: start,
            periodEnd: end,
            paidAt: paidAt,
